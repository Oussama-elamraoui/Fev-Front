...
import ChatArea from "../../../apps/Chat/ChatArea";
...
const Employe = () => {
  ...
  const [displayModalChatArea, setDisplayModalChatArea] = useState<boolean>(false)
  ...
  return (
    <>
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          ...
                          <span
                            ...
                            style={{color:'#FF8600',backgroundColor:'#FFC686'}}
                          >Bouknadel</span>
                        </td>
                        <td>
                          <span
                        ...
                        <td>
                          <i className="bi bi-chat-left-text-fill cursor-pointer" onClick={() => {
                            setSelectedUser({
                              id: employee.user.id,
                              name: employee.user.fullName,
                              avatar: !employee.user.image && employee.user.sexe === 'Homme'
                                ? 'https://png.pngtree.com/png-clipart/20230102/original/pngtree-business-man-avatar-png-image_8855195.png'
                                : 'https://img.freepik.com/vecteurs-premium/jeune-femme-souriante-ann-avatar-3d-vecteur-personnes-personnage-illustration-cartoon-style-minimal_365941-738.jpg',
                              totalUnread: 2,
                              userStatus: "busy",
      ...
      <ChatArea selectedUser={selectedUser} displayModalChatArea={displayModalChatArea}></ChatArea>
    </>
  );
};
