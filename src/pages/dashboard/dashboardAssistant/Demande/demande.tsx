...
import InfoP from "../Demande/Forms/infoP";
import InfoS from "../Demande/Forms/infoS";
import InfoV from "../Demande/Forms/infoV";
import ServiceP from "../Demande/Forms/serviceP";
...
const Demande = () => {
  ...
  const accordianContentFemme: ContentType[] = [
    {
      id: 1,
      title: "Information Primaires",
      titleAr: "معلومات اولية",
      text: ``,
    },
    {
      id: 2,
      title: "Informations socio-démographique",
      titleAr: "معلومات سوسيوديمغرافية",
      text: ``,
    },
    {
      id: 3,
      title: "Informations sur la violence",
      titleAr: "معلومات حول العنف",
      text: ``,
    },
    // {
    //   id: 4,
    //   title: "la visite de l'unité et services prodiguée ",
    //   titleAr: "زيارة الوحدة والخدمات المقدمة",
    //   text: ``,
    // },
      ...
      <Card className={classNames(index + 1 === length ? "mb-0" : "mb-1")}>
        ...
        >
          <div className="d-flex justify-content-between">
            ...
            <div className="d-flex justify-content-end">{item.titleAr}</div>
          </div>
          <i className="uil uil-angle-down h3  icon" style={{color:'orange'}}></i>
        </CustomToggle>
