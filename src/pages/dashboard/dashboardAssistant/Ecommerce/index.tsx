...
const EcommerceDashboard = () => {
  ...
  return (
    <>
        ...
        <Col>
          <div className="page-title-box">
            ...
            <Dropdown as={ButtonGroup}>
                ...
                Ajouté rendez-vous <i className="uil uil-angle-down"></i>
                </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item href="#">Calendrier Médecin</Dropdown.Item>
                <Dropdown.Item href="#">Calendrier Psychologue</Dropdown.Item>
              </Dropdown.Menu>
                </Dropdown>
                </ButtonGroup>
                    </div>
      ...
      <Row>
        <Col xl={4}>
          <MembersList title={"FONCTIONNERS"} members={topPerformers} />
        </Col>
        <Col xl={4}>
          <Tasks tasks={tasks} />
        </Col>
        <Col xl={4}>
          <ChatList title="ANCIEN CONVERSATION" messages={chatMessages} />
        </Col>
      </Row>
    </>
  );
