...
const NewTable = () => {
  ...
  const ModalComponent = () => {
    ...
    // useEffect(() => {
    //   if (testSelectedServiceProdigueAr!==selectedServiceProdigueAr) {
    //     setTestSelectedServiceProdigueFr([])
    //     if (selectedServiceProdigueAr.length) {
    //       selectedServiceProdigueAr.map((item) => {
    //         serviceProdigue.map((serv) => {
    //           if (item.value === serv.serviceAR) {
    //             let temp = { label: serv.service, value: serv.service}
    //             testSelectedServiceProdigueFr.push(temp);
    //             console.log(selectedServiceProdigueFr);
    //           }
    //         }
    //         )
    ...
    //     }
    //     else {
    //       setSelectedServiceProdigueFr([])
    //     }
    //     setTestSelectedServiceProdigueAr(selectedServiceProdigueAr);
    //     setSelectedServiceProdigueFr(testSelectedServiceProdigueFr)
    //   }
    //   if(testSelectedServiceProdigueFr!==selectedServiceProdigueFr){
    //     setTestSelectedServiceProdigueAr([])
    //     if (selectedServiceProdigueFr.length) {
    //       selectedServiceProdigueFr.map((item) => {
    //         serviceProdigue.map((serv) => {
    //           if (item.value === serv.service) {
    //             let temp = { label: serv.serviceAR, value: serv.serviceAR}
    //             testSelectedServiceProdigueAr.push(temp);
    ...
    //       setSelectedServiceProdigueFr([])
    //     }
    //     setTestSelectedServiceProdigueFr(selectedServiceProdigueFr);
    //     setSelectedServiceProdigueAr(testSelectedServiceProdigueAr)

    //   }
    // }, [selectedServiceProdigueAr])
    // useEffect(() => {
    //   if (selectedServiceProdigueAr.length) {
    //     selectedServiceProdigueAr.map((item) => {
    //       serviceProdigue.map((serv) => {
    //         if (item.value === serv.serviceAR) {
    //           let temp = { label: serv.service, value: serv.service }
    //           selectedServiceProdigueAr.push(temp);
    //         }
    //       }
    //       )
    //     })
    //   }
    //   else {
    //     setSelectedServiceProdigueAr([])
    //   }
    // }, [optionsServiceProdigueAr,optionsServiceProdigueAr])
        ...
        <Box sx={style}>
          ...
          <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
            ...
            <div className="d-flex justify-content-between mt-2 mb-2">
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label">Manifestations de détresse émotionnelle</InputLabel>
                  <Select
                    ...
                    input={<OutlinedInput label="Manifestations de détresse émotionnelle" />}
              ...
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label"> مظاهر التوتر العاطفي</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label=" مظاهر التوتر العاطفي" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
                    {serviceProdigue.map((item) => (
            ...
            <div className="d-flex justify-content-between mt-2 mb-2">
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label">Troubles mentaux caractérisés</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label="Troubles mentaux caractérisés" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
              ...
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label"> الاضطرابات النفسية المميزة</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label="الاضطرابات النفسية المميزة" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
                    {serviceHospitalier.map((item) => (
            ...
            <div className="d-flex justify-content-between mt-2 mb-2">
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label">Troubles somatoformes</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label="Troubles somatoformes" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
              ...
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label">الاضطرابات الجسدية ذات الشكل النفسي</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label="الاضطرابات الجسدية ذات الشكل النفسي" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
                    {certificatMedial.map((item) => (
            ...
            <div className="d-flex justify-content-between mt-2 mb-2">
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label">Troubles du sommeil</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label="Troubles du sommeil" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
              ...
              <div className="col-sm-5 ">
                <FormControl sx={{ m: 1, width: 300 }}>
                  <InputLabel id="demo-multiple-checkbox-label"> اضطرابات النوم</InputLabel>
                  <Select
                    labelId="demo-multiple-checkbox-label"
                    id="demo-multiple-checkbox"
                    multiple
                    ...
                    input={<OutlinedInput label=" اضطرابات النوم" />}
                    renderValue={(selected) => selected.join(', ')}
                    MenuProps={MenuProps}
                  >
                    {etablissement.map((item) => (
